                    ...
                    <div className="max-w-[300px]   sm:max-w-sm w-[100%]  h-[auto] mx-auto  relative flex flex-col py-2 px-4 rounded-2xl text-black bg-white ">
                        ...
                        <form className="flex flex-col gap-2" onSubmit={handleSubmit}>
                            <div className="block relative">
                                ...
                                <input type="text" id="username" name='username' maxLength="15" className="rounded border border-gray-200 text-sm w-full font-normal leading-[18px] text-black tracking-[0px] appearance-none block h-11 m-0 p-[11px] focus:ring-2 ring-offset-2  ring-gray-900 outline-0" value={usersignup.username}
