...
function Cart({ cartnew, remove, removeAll, handleChange, totalPrice }) {
    ...
    return (
        ...
        <div className='p-4'>
            ...
            {cartnew.length === 0 ? "" :
                <div className='   hidden sm:flex   w-full       items-center   justify-around   py-5      border-b-2    '  >
            ...
            <div>
                    ...
                    <>
                        ...
                        <div className=' flex items-center justify-center flex-col'>
                            ...
                            <div className=' flex items-center justify-center flex-col'>
                                ...
                                <Link to={'/page'}>
                                    <button className=' px-8  my-6   py-2 bg-blue-300 hover:bg-blue-200  rounded-md  text-black'>Add ➕</button></Link>
                    ...
                    (
                        cartnew.map((item) => (
                            <div className=' p-4 ' key={item.id}>
                                {/* {console.log(item)} */}
                                <div className='  flex  flex-auto  hover:bg-gray-200  flex-col sm:flex-row  rounded-md   items-center   justify-around py-5      border-b-2  px-2   ' key={item.id}>
                                    <Link to={`/product/${item.id}`}>
                                        <div className=' w-[auto]  flex items-center justify-between gap-3  object-cover rounded-md '>
                                            ...
                                            <div  >
                                                ...
                                                <h1 className='text-black text-center'>{item.category}</h1>
                                    ...
                                    <div className=' flex  m-2 flex-col sm:flex-row    items-center justify-center       gap-3'>
                                        ...
                                        <div className=' flex items-center justify-center flex-col gap-3'>
                                            ...
                                            <button className=' px-4 py-2 bg-blue-300  rounded-md  hover:bg-blue-700 text-black  ' onClick={() => remove(item.id)}>Remove </button>
                ...
                <div className=' flex  flex-col sm:flex-row items-center justify-between p-4    '>
                    <div className='text-center mx-auto '>
                        ...
                        < h1 className=' text-center font-extrabold   font-mono text-4xl text-[#543fb3] f '>Total Amt $- {Math.round(totalPrice * 1.18)}💵</h1>
                        <button className=' px-4 py-2  bg-gray-400  my-4   rounded-md  hover:bg-gray-700 text-black  ' onClick={removeAll}>RemoveAll </button>
                    </div>



                    <div className="lg:w-96 md:w-8/12 w-full bg-gray-600   h-full float-end">
                        <div className="flex flex-col lg:h-screen h-auto lg:px-8 md:px-7 px-4 lg:py-20 md:py-10 py-6 justify-between overflow-y-auto">
                            ...
                            <div>
                                ...
                                <button className="text-base leading-none w-full py-5 bg-gray-800 border-gray-800 border focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 text-white dark:hover:bg-gray-700" onClick={openModal}  >Checkout</button>
            ...
            >
                ...
                <div className="min-w-[60vw] min-h-[100vh] bg-gray-200 flex    pt-12">
                    <div className="  max-w-[50vw] sm:max-w-[30vw] w-[100%] h-[auto]   mx-auto rounded-lg bg-white shadow-lg p-4 mb-4 text-gray-700"  >
